    ...
    <section className="relative border-b border-border/20">
      <div className="min-h-[70vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-4xl mx-auto">
          <Heading size="xl" className="text-4xl md:text-6xl lg:text-7xl mb-8 font-light tracking-tight">
            {title}
          </Heading>
          
          <Text variant="lead" className="text-xl md:text-2xl mb-8 text-muted-foreground font-light">
            {subtitle}
          </Text>
          
          <Text variant="muted" className="max-w-2xl mx-auto mb-12 text-base leading-relaxed">
            {description}
          </Text>
