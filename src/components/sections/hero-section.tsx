  ...
  const slides = [
    {
      ...
      description: "Where precision meets artistry in Calgary's most refined nail salon atmosphere",
    ...
    },
    {
      ...
      description: "Immerse yourself in Calgary's premier minimalistic nail sanctuary on 14 St SW",
